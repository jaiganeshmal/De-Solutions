      ...
      <div className="container mx-auto px-6 flex flex-col lg:flex-row items-stretch gap-16">
        ...
        <div className="lg:w-1/2 flex flex-col justify-center space-y-8 relative">
          ...
          <div className="relative">
            <h2 className="text-4xl md:text-5xl lg:text-5xl font-extrabold leading-snug relative z-10">
              Scale-Up With Our <br />
              <span className="text-[#0DACAF] relative z-10">Services</span>
            </h2>
            {/* Shadow text behind */}
            <span className="absolute top-0 left-0 text-[5rem] md:text-[7rem] lg:text-[8rem] font-extrabold text-gray-200 opacity-10 select-none z-0">
              Services
            </span>
          </div>
